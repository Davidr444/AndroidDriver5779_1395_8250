...
import com.jct.davidandyair.androiddriver5779_1395_8250.controller.activities.LoginActivity;
...
public class MyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "default");
                builder.setContentTitle(context.getString(R.string.relevent_drive))
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            builder.setColor(getColor(context, R.color.colorAccent));
        } else {
            builder.setSmallIcon(R.drawable.ic_directions_car_black_24dp);
        }
